// ══════════════════════════════════════════════════════════════
// 🗺️ KisanMitra — Geo Utilities (mirrors backend location.service)
//    Local bounding-box lookup — no API key needed.
//    Used as a fallback when Nominatim reverse geocode fails.
// ══════════════════════════════════════════════════════════════
