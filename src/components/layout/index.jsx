  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      ...
      >
        ...
        <span className="navbar-lang-native">{current.native}</span>
  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        {/* Logo */}
        <button onClick={() => navigate("home")} className="navbar-logo-btn" style={{
          background: "none", border: "none", cursor: "pointer",
          display: "flex", alignItems: "center", gap: 10, flexShrink: 0,
          minWidth: 0,
        }}>
          <span style={{ fontSize: 30, flexShrink: 0 }}>🌾</span>
          <span className="navbar-app-name" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "nowrap", flexShrink: 0 }}>
          {page !== "home" && (
            <Btn onClick={() => navigate("home")} variant="ghost" size="sm"
              ...
              🏠 <span className="navbar-home-label">{t.home}</span>
            </Btn>
          )}
