    ...
    <PageShell title="खाद सुझाव" icon="🌱">
      ...
      {result?._source === "backend" && (
        <div style={{ animation: "fadeUp .4s ease" }}>
          ...
          <div className="responsive-grid-3" style={S.npkGrid}>
...
const S = {
  ...
  npkGrid: { gap:14, marginBottom:24 }, // grid + columns now come from the "responsive-grid-3" CSS class (was a fixed repeat(3,1fr) that stayed 3-wide even on narrow phones)
