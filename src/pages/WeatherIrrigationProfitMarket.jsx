        ...
        return (
          <ResultSection>
            ...
            {/* ══════════════════════════════════════
                📊 COLORFUL STAT CARDS
            ══════════════════════════════════════ */}
            <div className="stat-grid-4" style={{ gap:12, marginBottom:20 }}>
              {[
            ...
            <div style={{ marginBottom:24 }}>
              ...
              <div className="forecast-grid-7" style={{ gap:8 }}>
                {forecast.map((day, i) => (
    ...
    <PageShell title={t.marketPrice} icon="📈">
          ...
          {result?._source === "backend" && (
            <>
              ...
              <div style={{ background:"#fff", borderRadius:18, padding:"22px", border:"2px solid #fde68a", marginBottom:20, boxShadow:"0 4px 16px rgba(245,158,11,.15)" }}>
                ...
                <div className="two-col-grid" style={{ gap:12, marginBottom:14 }}>
              ...
              {result.prices?.length > 0 && (
                <div style={{ background:"#fff", borderRadius:18, padding:"22px", border:"2px solid #e2e8f0", marginBottom:20, boxShadow:"0 4px 16px rgba(0,0,0,.06)" }}>
                  ...
                  {/* Table header */}
                  <div className="mandi-row" style={{ gap:8, padding:"10px 14px", background:"linear-gradient(135deg,#0d3b1e,#1a7a3c)", borderRadius:"10px 10px 0 0", color:"#fff", fontSize:12, fontWeight:800, textTransform:"uppercase" }}>
                  ...
                  {result.prices?.slice(0,12).map((p, i) => (
                    <div key={i} className="mandi-row" style={{ gap:8, padding:"12px 14px", background: i%2===0 ? "#fff" : "#f8fafc", borderBottom:"1px solid #f1f5f9", alignItems:"center" }}>
                      <div>
      ...
      {activeTab === "compare" && (
        <div style={{ background:"#fff", borderRadius:20, padding:"24px", border:"2px solid #e2e8f0", boxShadow:"0 4px 20px rgba(0,0,0,.06)" }}>
          ...
          <div className="two-col-grid" style={{ gap:16, marginBottom:20 }}>
            {/* Crop 1 */}
            <div>
              <div style={{ fontWeight:800, fontSize:13, color:"#1a7a3c", marginBottom:8, textTransform:"uppercase" }}>🅰️ Pehli Fasal</div>
              <div className="stat-grid-4" style={{ gap:6, marginBottom:10 }}>
